package kardex.PEPS.InventoryPEPS.unit.infrastucture.output.exception;
...
import kardex.PEPS.InventoryPEPS.infrastructure.adapters.output.exception.FormatterResultOutputPort;
...
public class FormatterResultOutputPortUnitTest {
